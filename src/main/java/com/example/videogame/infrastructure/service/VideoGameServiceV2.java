...
public class VideoGameServiceV2 {

    private static final Logger LOGGER = LoggerFactory.getLogger(VideoGameServiceV2.class);

    private final ApiDetails apiDetails;

    private final String token;

    public VideoGameServiceV2(ApiDetails apiDetails,
                              String token) {
    ...
    public Response getAllVideoGames() {
        ...
        try {
            ...
            return RestAssured.given()
                    .baseUri(apiDetails.baseUrl() + apiDetails.apiVersion2() + "/")
